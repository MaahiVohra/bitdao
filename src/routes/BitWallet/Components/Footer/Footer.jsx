			...
			<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900 mt-20 text-orange-600">
				<div className="md:flex md:justify-between">
					<div className="mb-6 md:mb-0">
						<a className="flex items-center">
							<img
								src={bitwalletlogo}
								className="h-20 mr-3 rounded-xl"
								alt="FlowBite Logo"
							/>
				...
				<div className="sm:flex sm:items-center sm:justify-between mt-20">
					...
					<div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
						<a
							href="https://www.linkedin.com/company/beyond-imagination-technlogies-pvt-ltd/?viewAsMember=true"
						...
						<a
							href="https://www.instagram.com/bitindiaofficial/"
							target="_blank"
							className="text-gray-500 hover: dark:hover:text-white">
							<svg
								className="w-10 h-10"
